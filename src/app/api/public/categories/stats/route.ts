...
// Public endpoint for category statistics - no auth required
export async function GET(request: NextRequest) {
  try {
    ...
    // Get counts for each asset type - count all non-archived assets
    // Since this is a public endpoint, we'll count all visible assets
    const [
      videoCount,
      imageCount,
      model3dCount,
    ...
    console.error('Get public category stats error:', error)
