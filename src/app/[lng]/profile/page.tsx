...
import ProfileContentConnected from '@/components/ProfileContentConnected'
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10">
        ...
        <div className="absolute top-20 right-1/4 w-96 h-96 bg-gradient-to-br from-blue-500/20 to-indigo-500/20 rounded-full blur-3xl animate-float" />
        ...
        <div className="absolute top-1/2 left-1/4 w-72 h-72 bg-gradient-to-br from-cyan-500/15 to-teal-500/15 rounded-full blur-3xl animate-float animation-delay-4000" />
      ...
      <main className="pt-16">
        <ProfileContentConnected lng={lng} />
      </main>
